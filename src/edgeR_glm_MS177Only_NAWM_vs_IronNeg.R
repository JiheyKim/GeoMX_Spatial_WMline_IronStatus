...
# Contrast for gWM_line_Lesion_2 vs. gNAWM
contrast <- makeContrasts(gWM_line_Lesion_2 - gNAWM, levels = design)
...
# Save all genes
write.table(all_genes, file="WMline_IronNeg_vs_NAWM_AllGenes.txt", quote=F, sep="\t")
...
write.table(significant_genes, file="WMline_IronNeg_vs_NAWM_FDR005.txt", quote=F, sep="\t")
...
output_file <- "WMline_IronNeg_vs_NAWM_FDR005_wGeneName.jpg"
